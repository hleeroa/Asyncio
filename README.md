...
**birth_year** <br>
**eye_color** <br>
**films** - список с названиями фильмов через запятую <br>
**gender** <br>
**hair_color** <br>
**height** <br>
**homeworld** <br>
...
**name** <br>
**skin_color** <br>
**species** - список с названиями типов через запятую <br>
**starships** - список с названиями кораблей через запятую <br>
**vehicles** - список с названиями транспорта через запятую <br>
